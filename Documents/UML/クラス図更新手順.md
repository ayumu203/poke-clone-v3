...
**追加プロパティ:**
- `Money: int` - 所持金（初期値: 3000）

### EndResultクラスの更新

**追加プロパティ:**
- `MoneyGained: int` - 獲得した所持金

### 更新手順

1. **Playerクラス**を更新:
   - `Money: int = 3000`プロパティを追加

2. **EndResultクラス**を更新:
   - `MoneyGained: int`プロパティを追加

## 最終確認事項

- [ ] Playerクラスに`Money`プロパティが追加されている
- [ ] EndResultクラスに`MoneyGained`プロパティが追加されている
