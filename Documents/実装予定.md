...
**curlテスト例**:
```bash
curl -X GET http://localhost:5000/api/Party \
  -H "Authorization: Bearer {YOUR_TOKEN}"
```
...
**curlテスト例**:
```bash
curl -X DELETE http://localhost:5000/api/Party/{pokemonId} \
  -H "Authorization: Bearer {YOUR_TOKEN}"
```
...
**curlテスト例**:
```bash
curl -X GET http://localhost:5000/api/Starter/options \
  -H "Authorization: Bearer {YOUR_TOKEN}"
```
...
**curlテスト例**:
```bash
curl -X POST http://localhost:5000/api/Starter/select \
  -H "Authorization: Bearer {YOUR_TOKEN}" \
  -H "Content-Type: application/json" \
...
**curlテスト例**:
```bash
curl -X GET http://localhost:5000/api/Battle/{battleId} \
  -H "Authorization: Bearer {YOUR_TOKEN}"
```
